...
def about_text() -> str:
    return "\n".join(
        [
            ...
            "Shift score: Combined magnitude of entropy, dominant-share, and packet-rate deviations.",
            "Alert level: NONE/INFO/WARNING/CRITICAL based on shift score and trigger rules.",
            "",
            "Export and MATLAB/Octave",
            "-------------------------",
            "Export CSV and Export MATLAB save files into the project's exports folder.",
            "A floating notification appears after export with the output path.",
            "The exported .m file contains data vectors plus plotting commands.",
            "Run the .m file in MATLAB or Octave to reproduce H(X), Bernoulli, and rate charts.",
            "",
